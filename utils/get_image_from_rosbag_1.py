...
def save_frame_from_rosbag(bag_path, image_topic, output_filename, frame_number=0):
    """
    Extracts a specific frame from an image topic in a ROS 2 bag (.mcap format)
...
if __name__ == '__main__':
    ...
    save_frame_from_rosbag(bag_folder, camera_topic, output_file)

    # To save a specific frame (e.g., the 100th frame):
    # save_frame_from_rosbag(bag_folder, camera_topic, 'frame_100.jpg', frame_number=99)

    # To save the last frame:
    # save_frame_from_rosbag(bag_folder, camera_topic, 'last_frame.jpg', frame_number=None)
